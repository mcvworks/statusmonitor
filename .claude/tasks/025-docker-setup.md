...
## Acceptance Criteria
- [ ] `docker compose up --build` builds and starts the app
...
- [ ] Nginx reverse proxy config included for `monitor.ducktyped.com`
- [ ] Commit: "feat: add Docker setup with multi-stage build"
