...
const KNOWN_SERVICES: KnownService[] = [
  ...
  { name: "Google Workspace Email", provider: "google-workspace" },
  { name: "Google Workspace Drive", provider: "google-workspace" },
  { name: "Vercel Hosting", provider: "vercel" },
  { name: "Netlify Hosting", provider: "netlify" },
  ...
  { name: "npm Packages", provider: "npm-registry" },
  // Microsoft 365
  { name: "Outlook", provider: "m365" },
  { name: "Teams", provider: "m365" },
  { name: "SharePoint", provider: "m365" },
  { name: "OneDrive", provider: "m365" },
];
...
const STACK_PRESETS: StackPreset[] = [
  {
    ...
    services: [
      { serviceName: "Vercel Hosting", provider: "vercel" },
  ...
  },
  {
    ...
    services: [
      ...
      { serviceName: "Outlook", provider: "m365" },
      { serviceName: "Teams", provider: "m365" },
      { serviceName: "SharePoint", provider: "m365" },
  ...
  },
  {
    ...
    services: [
      ...
      { serviceName: "GitHub Actions", provider: "github" },
      { serviceName: "Stripe Payments", provider: "stripe" },
      { serviceName: "npm Packages", provider: "npm-registry" },
    ],
  },
];
