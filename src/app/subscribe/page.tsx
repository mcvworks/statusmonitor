  ...
  return (
    <div className="mx-auto max-w-3xl space-y-6">
      ...
      <section className="glass-card space-y-4 rounded-2xl p-5 sm:p-7" aria-labelledby="email-help-heading">
        ...
        <details className="text-sm"><summary className="cursor-pointer font-medium text-text-primary">How do I stop receiving alerts?</summary><p className="mt-2 leading-6 text-text-secondary">Use Unsubscribe in an alert email, or <Link href="/subscribe/manage" className="text-primary underline">request a management link</Link>, then select Unsubscribe from email alerts. Stop browser notifications or disconnect Slack and Teams separately in <Link href="/dashboard/settings" className="text-primary underline">alert settings</Link>.</p></details>
      </section>
    </div>
  );
}
